<div class="py-12 bg-white">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        Customer <span class="text-primary font-semibold">Testimonials</span> 
        </h2>


        <p class="text-gray-600 mt-2 text-center">
            Our professionals ensure a seamless setup for your smart home devices. Enjoy secure and hassle-free installation tailored to your needs.
        </p>
        ...
        <div class="mt-10 relative">
            ...
            <div class="swiper-wrapper">
                    @foreach($testimonials as $testimonial)
                        <div class="swiper-slide flex justify-center items-center">
                            ...
                            <div class="bg-gray-100 p-8 rounded-xl shadow-lg max-w-5xl mx-auto text-center flex flex-col items-center">
                                ...
                                <p class="text-gray-600 mt-4 leading-relaxed">{{ $testimonial['review'] }}</p>
                ...
                <!-- Navigation Arrows -->
                <div 
                    class="absolute z-50 left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white rounded-full w-[50px] h-[50px] flex items-center justify-center cursor-pointer shadow-lg prev hover:bg-gray-700 transition-all duration-300"
                >
                ...
                <div 
                    class="absolute z-50 right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white rounded-full w-[50px] h-[50px] flex items-center justify-center cursor-pointer shadow-lg next hover:bg-gray-700 transition-all duration-300"
                >
