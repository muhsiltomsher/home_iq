<div id="account-drawer" 
    ...
    <div class="flex items-center justify-between bg-opacity-60 w-full  border-b border-gray-300 p-6">
                    ...
                    <div class=" w-full h-auto flex justify-start items-center  transition-all mt-5 px-6">
                        ...
                        <div class="relative py-2 grid gap-3 grid-cols-2  w-full overflow-hidden">
                            ...
                            <a href="address_book.html" class="px-3 py-6 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#65b54c] group">
                                ...
                                <p class="inline-flex items-center justify-center ml-2 text-sm font-medium w-full hover:text-[#65b54c]">
                                    My Address Book </p>
                            </a>


                            <a href="wishlist.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#65b54c] group">

                                <svg class="w-[30px] group-hover:fill-[#65b54c]" id="fi_13369080" enable-background="new 0 0 100 100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="my_order.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#65b54c] group">


                                <svg class="w-[30px] group-hover:fill-[#65b54c]" id="fi_6737602" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="my_wallet.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#65b54c] group">


                            <svg class="w-[30px] group-hover:fill-[#65b54c]" ca xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-lock" viewBox="0 0 16 16">
  <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m0 5.996V14H3s-1 0-1-1 1-4 6-4q.845.002 1.544.107a4.5 4.5 0 0 0-.803.918A11 11 0 0 0 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664zM9 13a1 1 0 0 1 1-1v-1a2 2 0 1 1 4 0v1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1zm3-3a1 1 0 0 0-1 1v1h2v-1a1 1 0 0 0-1-1"/>
                            ...
                            <a href="login.html" class="px-3 py-4 flex flex-col items-center rounded-md border  gap-y-4 text-center hover:bg-gray-50 w-full bg-white hover:text-[#65b54c] group">


                                <svg class="w-[30px] group-hover:fill-[#65b54c]" version="1.1" id="fi_126467" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 471.2 471.2" style="enable-background:new 0 0 471.2 471.2;" xml:space="preserve">
                                    <g>
                                        <g>
