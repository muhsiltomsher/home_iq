...
<div class="bg-white rounded-lg shadow-lg p-3 lg:p-6 max-w-md mx-auto ">
   ...
   <div class="text-center mt-6">
      <div class="flex gap-2">
         <a href="404.html" class="flex items-center justify-center w-full px-4 py-2.5 text-sm font-bold text-white transition-all border  border-[#41b6e8] duration-200 bg-[#41b6e8]  hover:text-[#41b6e8]  hover:bg-[#d7f0db]" href="order-field.html">Continue Shopping</a>
      </div>
   </div>
</div>
</div>
