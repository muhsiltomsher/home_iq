    ...
    <h1 class="text-4xl font-extrabold text-center text-gray-800 mb-6">Register</h1>
        ...
        <form action="#" method="POST" class="space-y-6">
            <div>
                ...
                <input type="text" id="name" name="name" required class="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm">
            </div>
            ...
            <div>
                ...
                <input type="password" id="confirm-password" name="confirm-password" required class="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm">
            </div>
        ...
        <p class="text-center text-gray-700 mt-6 text-sm">Already have an account? <a href="#" class="text-blue-600 font-medium hover:underline">Login</a></p>
    </div>
    </div>
